            ...
            {showResults && searchResults.length > 0 && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-card rounded-xl shadow-lg border border-border overflow-hidden z-50">
                ...
                <Link
                  ...
                  className="block p-3 text-center text-primary hover:bg-muted/30 font-medium text-sm"
                >
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/opac/account" className="flex items-center gap-3">
                      <User className="h-4 w-4" /> My Account
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/opac/account/checkouts" className="flex items-center gap-3">
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/opac/account/holds" className="flex items-center gap-3">
