...
const categories: Category[] = [
  {
    ...
    description: "Dragons, wizards, and magical adventures!",
  },
  {
    id: "scifi",
    label: "Space & Sci-Fi",
    ...
    color: "text-blue-600",
    bgColor: "bg-blue-100",
    description: "Explore space and the future!",
  },
  {
    id: "horror",
    ...
    bgColor: "bg-muted/50",
    description: "Thrilling and scary tales!",
  },
  {
    id: "adventure",
    label: "Adventure",
  ...
  },
  {
    ...
    description: "Books that will make you laugh!",
  },
  {
    id: "dogs",
    label: "Dogs",
    ...
    description: "All about our furry friends!",
  },
  {
    id: "cats",
    label: "Cats",
    ...
    description: "Purrfect stories about cats!",
  },
  {
    id: "ocean",
    label: "Ocean Life",
  ...
  },
  {
    ...
    color: "text-lime-600",
    bgColor: "bg-lime-100",
    description: "Creepy crawly creatures!",
  },
  {
    id: "birds",
    label: "Birds",
    ...
    color: "text-sky-600",
    bgColor: "bg-sky-100",
    description: "Feathered friends that fly!",
  },
  {
    id: "nature",
    label: "Nature",
  ...
  },
  {
    ...
    description: "Sing, dance, and play!",
  },
  {
    id: "art",
    label: "Art & Crafts",
  ...
  },
  {
    ...
    description: "Cars, trucks, trains, and planes!",
  },
  {
    id: "princesses",
    label: "Princesses",
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-foreground mb-2">Browse by Category</h1>
        ...
        {categories.map((category) => {
          ...
          return (
            ...
            >
              ...
              <div
                className="flex items-center gap-1 text-purple-600 text-sm font-medium opacity-0 
...
export default function KidsBrowsePage() {
  const _t = useTranslations("kidsBrowse");
  return (
    <Suspense
      fallback={
        <div className="flex items-center justify-center py-20">
