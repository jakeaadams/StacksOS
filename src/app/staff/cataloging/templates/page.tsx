...
const templateCards: TemplateCard[] = [
  {
    ...
    description: "Create and manage templates for item copies. Apply default values for status, location, circulation modifiers, and more when adding new copies.",
  ...
  },
  {
    ...
    description: "Manage templates for call number and holdings information. Define default prefixes, suffixes, and classification schemes.",
      ...
      <PageContent className="space-y-6">
        <Card className="rounded-2xl">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Templates help standardize cataloging by providing reusable sets of default values.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="text-sm text-muted-foreground">
            <p>
              Use templates to speed up cataloging workflows. Copy templates define default item attributes,
              while holdings templates provide standard call number formats and prefixes.
            </p>
          </CardContent>
        </Card>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-lg border p-4">
                ...
                <p className="text-xs">
                  ...
                  circulation modifier, holdability, and price. Apply these templates when 
                  creating new copies to ensure consistency.
                </p>
              </div>
              <div className="rounded-lg border p-4">
                <h4 className="font-medium text-foreground mb-2 flex items-center gap-2">
                ...
                <p className="text-xs">
                  ...
                  schemes. Holdings templates help maintain consistent call number practices 
                  across your library system.
                </p>
              </div>
            </div>
          </CardContent>
