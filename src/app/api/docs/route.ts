 ...
 *
 * SECURITY: This route is gated behind staff authentication to mitigate
 * supply-chain risk from loading Swagger UI assets from unpkg.com CDN.
 * In the future, consider self-hosting swagger-ui-dist or adding SRI hashes.
 */
