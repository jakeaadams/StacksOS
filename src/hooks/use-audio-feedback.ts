...
const SOUNDS: Record<SoundType, string> = {
  ...
  "hold-ready": "data:audio/wav;base64,UklGRnoGAABXQVZFZm10IBAAAAABAAEAQB8AAEAfAAABAAgAZGF0YQoGAACA/4D/gP+A/5L/pP+2/8j/2v/s//7/EAAiADQARgBYAGoAfACOAKAAsgDEAIAAgACAAIAAkACgALAAwADQAOAA8AAAARAAIAAwAEAAUABgAHAAgACQAKAAsADAANAA4ADwAAABEAEgATABQAFQAWABcAGAAZABoAGwAcAB0AHgAfABAAI="
};
